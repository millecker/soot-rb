...
We notice a significant decrease in the number of classes loaded, with a decrease in processing time for the large test casse. Our method requires significantly less information to be loaded from the disk. This explains why the class loading performance improves for larger test cases.
