...
analayis making analysis infeasible on systems with four gigabytes of ram. This paper 
...
When loading this program in Soot in whole-program mode, without exclusions, the class loader fully loads 2031 \sootclass objects. With the \rb class loader it loads 712 \sootclass objects, representing an approximative reduction of 114 Mb in memory usage.
