...
compiler. The new class loader loaded a Scene that was 58.8\% smaller with
our test case.
\end{abstract}
...
We have shown data structures and algorithms to efficiently load a Soot Scene. In the DaCapo test case, the Scene is about 58.8\% smaller and the memory savings is about 56.8\%.
...
\bibitem[Blackburn et~al.(2006)Blackburn, Garner, Hoffman, Khan, McKinley,
  Bentzur, Diwan, Feinberg, Frampton, Guyer, Hirzel, Hosking, Jump, Lee, Moss,
  Phansalkar, Stefanovi\'{c}, {VanDrunen}, von Dincklage, and
  Wiedermann]{DaCapo:paper}
